...
-- TypeLabel: Hiển thị "RE" / "RF" — học từ bản gốc SimpleSpy Beta
-- Đặt phía trên ColorBar, đủ rộng để chữ hiện
TypeLabel.Name = "TypeLabel"
TypeLabel.Parent = RemoteTemplate
TypeLabel.BackgroundColor3 = Color3.new(1, 1, 1)
TypeLabel.BackgroundTransparency = 1
TypeLabel.Position = UDim2.new(0, 0, 0, 0)
TypeLabel.Size = UDim2.new(0, 14, 0, 9)
TypeLabel.ZIndex = 4
TypeLabel.Font = Enum.Font.SourceSansBold
TypeLabel.Text = "RE"
TypeLabel.TextColor3 = Color3.fromRGB(20, 20, 20)
...
Text.Position = UDim2.new(0, 14, 0, 1)
Text.Size = UDim2.new(0, 103, 0, 18)
Text.ZIndex = 2
...
📌 Copy Remote   → Copy đường dẫn remote vào clipboard
▶  Run Code      → Chạy code trong codebox
🔍 Func Info     → Xem thông tin hàm đã gọi remote
...
function newRemote(type, name, args, remote, function_info, blocked, src, returnValue)
	...
	-- Gán tên remote (dùng TextTruncate như bản gốc Beta — tránh mất chữ)
	remoteFrame.Text.Text = name  -- không sub, dùng TextTruncate.AtEnd

	-- Màu ColorBar + nhãn loại theo bản gốc SimpleSpy Beta
	if type == "event" then
		-- RemoteEvent → màu vàng + chữ "RE" tối
		remoteFrame.ColorBar.BackgroundColor3 = Color3.fromRGB(255, 242, 0)
		remoteFrame.TypeLabel.Text = "RE"
		remoteFrame.TypeLabel.BackgroundColor3 = Color3.fromRGB(255, 242, 0)
		remoteFrame.TypeLabel.BackgroundTransparency = 0
		remoteFrame.TypeLabel.TextColor3 = Color3.fromRGB(20, 20, 20)
	else
		-- RemoteFunction → màu tím + chữ "RF" trắng
		remoteFrame.ColorBar.BackgroundColor3 = Color3.fromRGB(99, 86, 245)
		remoteFrame.TypeLabel.Text = "RF"
		remoteFrame.TypeLabel.BackgroundColor3 = Color3.fromRGB(99, 86, 245)
		remoteFrame.TypeLabel.BackgroundTransparency = 0
